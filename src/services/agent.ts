...
export const agent = {
  ...
  runCommand: (request: { requestId: string; root: string; cwd: string; program: string; args: string[]; timeoutSecs: number; terminalMode?: "disabled" | "project" | "shell" | "admin"; shell?: "automatic" | "cmd" | "powershell" | "bash" | "zsh"; command?: string }, onEvent: (event: AgentCommandEvent) => void) => {
