...
Vareliox is a Tauri desktop application:
...
- Project paths are canonicalized and checked against traversal, symlinks, ignored directories, and platform-invalid names.
...
The project intentionally keeps agent mutations separate from provider networking. A model proposes structured operations; Vareliox validates, previews, approves, snapshots, and applies them locally.
